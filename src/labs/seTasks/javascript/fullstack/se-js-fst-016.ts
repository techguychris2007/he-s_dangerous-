...
of an auth flow. Graded frontend-only, focused purely on the gating logic; a real app must never
trust a client-side gate alone — the server has to re-check auth on every request too, since
