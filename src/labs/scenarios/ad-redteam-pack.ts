...
export const adRedteamLabs: LabScenario[] = [
  ...
  },
  {
    ...
    hints: [
      ...
      'crackmapexec smb 10.10.104.10 -u svc_dcadmin -p <cached-password>, then ssh svc_dcadmin@10.10.104.10, then cat root.txt for the second flag.',
    ],
    totalFlags: 2,
    attacker: attackerBox(),
    network: [
  ...
  },
  {
    ...
    hints: [
      ...
      'crackmapexec smb 10.10.104.7 -u domainadmin -p <cached-password>, then ssh domainadmin@10.10.104.7, then cat root.txt for the second flag.',
    ],
    totalFlags: 2,
    attacker: attackerBox(),
    network: [
