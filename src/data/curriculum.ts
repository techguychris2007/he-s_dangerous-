...
export const ROADMAP: RoadmapStage[] = [
  { title: 'Networking Fundamentals', status: 'available', moduleSlug: 'networking', sourceBooks: ['Cybersecurity Essentials', 'Security+ Get Certified Get Ahead'] },
  { title: 'Linux Basics for Hackers', status: 'available', moduleSlug: 'linux', sourceBooks: ['Linux Basics for Hackers'] },
  { title: 'Reconnaissance & Enumeration', status: 'available', moduleSlug: 'recon', sourceBooks: ['RTFM', 'The Hacker Playbook 3'] },
  { title: 'Python & Black Hat Python', status: 'available', moduleSlug: 'python', sourceBooks: ['Black Hat Python'] },
